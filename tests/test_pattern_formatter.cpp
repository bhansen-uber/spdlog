...
TEST_CASE("color range test1", "[pattern_formatter]")
{
    ...
    spdlog::details::log_msg msg(logger_name, spdlog::level::info, nullptr, spdlog::string_view_t(buf.data(), buf.size()));
...
TEST_CASE("color range test2", "[pattern_formatter]")
{
    ...
    std::string logger_name = "test";
    spdlog::details::log_msg msg(logger_name, spdlog::level::info, nullptr, "");
    memory_buf_t formatted;
    formatter->format(msg, formatted);
    REQUIRE(msg.color_range_start == 0);
...
TEST_CASE("color range test3", "[pattern_formatter]")
{
    ...
    std::string logger_name = "test";
    spdlog::details::log_msg msg(logger_name, spdlog::level::info, nullptr, "ignored");
    memory_buf_t formatted;
    formatter->format(msg, formatted);
    REQUIRE(msg.color_range_start == 0);
...
TEST_CASE("paddinng_truncate_funcname", "[pattern_formatter]")
{
    ...
    spdlog::details::log_msg msg1{spdlog::source_loc{"ignored", 1, "func"}, "test_logger", spdlog::level::info, nullptr, "message"};
    test_sink.log(msg1);

    spdlog::details::log_msg msg2{spdlog::source_loc{"ignored", 1, "function"}, "test_logger", spdlog::level::info, nullptr, "message"};
    test_sink.log(msg2);
...
TEST_CASE("clone-default-formatter", "[pattern_formatter]")
{
    ...
    std::string logger_name = "test";
    spdlog::details::log_msg msg(logger_name, spdlog::level::info, nullptr, "some message");
...
TEST_CASE("short filename formatter-1", "[pattern_formatter]")
{
    ...
    spdlog::details::log_msg msg(source_loc, "logger-name", spdlog::level::info, nullptr, "Hello");
    formatter.format(msg, formatted);
